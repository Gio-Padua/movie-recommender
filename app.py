...
import csv
from algorytm_new import find_most_similar_film, find_most_similar_desc
...
def solution():
    ...
    mov_desc = find_most_similar_desc(selected_value)
    return render_template('solution.html', generate_data=generate_datar, selected_value=selected_value, movie_desc = mov_desc)
